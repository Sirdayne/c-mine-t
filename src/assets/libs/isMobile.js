...
const android_phone = /\bAndroid(?:.+)Mobile\b/i;
...
const windows_tablet = /\bWindows(?:.+)ARM\b/i;
...
const other_firefox = /\bMobile(?:.+)Firefox\b/i;
const other_safari = /^((?!chrome).)*safari/i;
